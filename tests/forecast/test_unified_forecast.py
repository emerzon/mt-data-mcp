...
class TestUnifiedForecast(unittest.TestCase):
    ...
    def test_statsforecast_ci(self):
        ...
        res = forecaster.forecast(
            self.series, horizon=10, seasonality=24, params={}, ci_alpha=0.05
        )
        self.assertIsInstance(res, ForecastResult)
        self.assertEqual(len(res.forecast), 10)
    ...
    def test_generic_statsforecast(self):
        ...
        res = forecaster.forecast(
            self.series, horizon=10, seasonality=24, params={"model_name": "AutoARIMA"}
        )
        self.assertIsInstance(res, ForecastResult)
        self.assertEqual(len(res.forecast), 10)
    ...
    def test_sktime_method(self):
        ...
        res = forecaster.forecast(
            ...
            seasonality=1,
            params={
                "estimator": "sktime.forecasting.naive.NaiveForecaster",
                "strategy": "last",
            },
        )
        self.assertIsInstance(res, ForecastResult)
    ...
    def test_mlforecast_method_direct(self):
        ...
        res = forecaster.forecast(
            self.series, horizon=10, seasonality=1, params={"lags": [1, 2]}
        )
        self.assertIsInstance(res, ForecastResult)
        self.assertEqual(len(res.forecast), 10)
    ...
    def test_generic_mlforecast(self):
        ...
        if (
            importlib.util.find_spec("mlforecast") is None
    ...
    def test_engine_dispatch(self):
        ...
        with patch("mtdata.forecast.forecast_engine._fetch_history") as mock_fetch:
            ...
            # Test ensemble
            res = forecast_engine(
                "dummy", method="ensemble", horizon=5, params={"methods": "naive,theta"}
            )
            self.assertTrue(res["success"])
    ...
    def test_wrapper_dimred_no_nameerror(self):
        ...
        with (
            patch("mtdata.forecast.forecast._fetch_history", return_value=df),
