...
class TestFetchTicks(unittest.TestCase):
    ...
    def test_zero_spread_snapshots_preserve_both_quote_sides(self, mock_ctz, mock_info, mock_ticks):
        ...
        self.assertTrue(result['data'][0]['spread_valid'])
        ...
        self.assertTrue(result['data'][2]['spread_valid'])
        self.assertFalse(result['data'][2]['spread_sample_eligible'])
        self.assertEqual(result['data'][0]['spread_basis'], 'quote_snapshot')
        self.assertEqual(result['last_quote']['spread_basis'], 'quote_snapshot')
        self.assertEqual(result['data'][0]['mid'], 1.1)
        self.assertEqual(result['data'][0]['spread'], 0.0)
        self.assertEqual(result['data'][2]['mid'], 1.1003)
        self.assertEqual(result['data'][2]['spread'], 0.0)
