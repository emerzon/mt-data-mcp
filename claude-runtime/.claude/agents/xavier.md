...
- `trade_get_open`: Get a real-time list of all open positions.
- `trade_get_pending`: Get a real-time list of all pending orders.
...
1.  **Context & Risk Check:**
    ...
    -   Review pending orders using `trade_get_pending`.
