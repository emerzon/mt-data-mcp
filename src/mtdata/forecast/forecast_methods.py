...
def get_forecast_methods_data() -> Dict[str, Any]:
    ...
    add("statsforecast", "StatsForecast generic wrapper (select model via params.model_name)",
        [{"name": "model_name", "type": "str", "description": "StatsForecast model class name (e.g. AutoARIMA, MSTL, TBATS)"},
         {"name": "season_length", "type": "int", "description": "Season length (auto from timeframe if omitted)"}],
        ["statsforecast"],
        {"price": True, "return": True, "volatility": True, "ci": True})

    add("sktime", "sktime generic wrapper (select estimator via params.estimator)",
        [{"name": "estimator", "type": "str", "description": "Dotted class path (e.g. sktime.forecasting.theta.ThetaForecaster)"},
         {"name": "sp", "type": "int", "description": "Seasonal periodicity (auto from timeframe if omitted)"}],
        ["sktime"],
        {"price": True, "return": True, "volatility": True, "ci": True})
    ...
    return {
        ...
        "categories": {
            ...
            "statsforecast": ["statsforecast", "sf_autoarima", "sf_theta", "sf_autoets", "sf_seasonalnaive"],
            "sktime": ["sktime"],
