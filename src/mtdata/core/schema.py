...
PARAM_HINTS = {
    ...
    "model": "Model name within a library (e.g. AutoARIMA, ThetaForecaster).",
    "model_params": "Model parameters (JSON or k=v).",
    ...
    "params": "Method parameters (JSON or k=v).",
    ...
    "features": "Feature spec (JSON or k=v).",
    ...
    "place_kind": "Order kind to place (market or pending).",
    "modify_kind": "Order kind to modify (position or pending).",
    "list_mode": "List mode (symbols or groups).",
    "volume": "Order volume (lots).",
    "comment": "Order comment tag.",
    "deviation": "Max slippage (points).",
    "order_type": "Order type (BUY/SELL or explicit pending type).",
    "price": "Entry price (required for pending).",
    "stop_loss": "Stop-loss price.",
    "take_profit": "Take-profit price.",
    "ticket": "Ticket/order ID.",
    "expiration": "Expiration time (dateparser or GTC token).",
